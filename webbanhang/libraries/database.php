<?php 
    ...
    */
    class Database
    {
        ...
        {
            $this->link = mysqli_connect("localhost:3307","root","","thucphamsach") or die ();
        ...
        /** lấy hết tất cả dữ liệu trong mảng đấy */
        ...
        public  function fetchJones($table,$sql,$page = 1,$row ,$pagi = true)
        {
